Quant-specific guardrails — apply when this work touches data, signals, models, or backtests:

- **No lookahead**: features at time t may only use information available at or before t.
- **No leakage**: train/test/validation splits temporally or logically disjoint. Cross-validation respects time order.
